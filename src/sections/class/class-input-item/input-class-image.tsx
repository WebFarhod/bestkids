...
interface IProps {
  setValue: UseFormSetValue<IClass>;
  getValues: UseFormGetValues<IClass>;
}

const InputClassImage = ({ setValue, getValues }: IProps) => {
...
export default memo(InputClassImage);
