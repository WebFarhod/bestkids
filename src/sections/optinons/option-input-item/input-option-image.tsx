...
interface IProps {
  setValue: UseFormSetValue<IOption>;
  getValues: UseFormGetValues<IOption>;
}

const InputOptionImage = ({ setValue, getValues }: IProps) => {
      ...
      {selectedImage == "" ? (
        ...
        <div>
          ...
          >
            ...
            <LuImageOff
              color={error.main}
              className="class-image-icon-remove"
            />
          </Box>
        </div>
      )}
...
export default memo(InputOptionImage);
