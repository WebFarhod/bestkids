...
import { IProgram, IProgramInfo } from "../../../types/programType";
import { ProgramFieldType } from "../program-input";
// import { ITeacher, IProgramInfo } from "../../../../types/teacherType";
...
export default function InputProgramInfo({
  control,
  errors,
  trigger,
  name,
                      ...
                      >
                        ...
                        >
                          <TextField
                            ...
                            // placeholder={""}
                            variant="outlined"
                            value={(info as IProgramInfo).info}
                            fullWidth
                            margin="normal"
