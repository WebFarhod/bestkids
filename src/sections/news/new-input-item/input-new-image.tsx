...
`;
interface IProps {
  setValue: UseFormSetValue<INew>;
  getValues: UseFormGetValues<INew>;
}

const InputNewImage = ({ setValue, getValues }: IProps) => {
      ...
      {selectedImage == "" ? (
        ...
        <div>
          ...
          >
            ...
            />
            <LuImageOff color={error.main} className="new-image-icon-remove" />
          </Box>
        </div>
      )}
...
export default memo(InputNewImage);
